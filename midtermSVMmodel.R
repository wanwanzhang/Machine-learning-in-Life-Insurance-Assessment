...
library(gbm)
library(survival)
train_cleaned<- read.csv("C:/Users/Wanwan Zhang/Desktop/2016FALL/ADS/midterm project/train_cleanedfinal.csv")
train_cleaned600=train_cleaned[1:1000,]
...
system.time(pred <- predict(svm_model,xtext))
